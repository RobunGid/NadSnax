...
class ItemSchema(PlainItemSchema):
    ...
    def __init__(self, include_category=False, include_type=False, include_item_details=True, include_reviews=False, include_images=True, include_favorite=False, **kwargs):
        exclude_fields = set()
        if not include_category:
            exclude_fields.add("category")
