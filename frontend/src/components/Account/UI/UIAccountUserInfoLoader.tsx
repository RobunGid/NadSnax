export const UIAccountUserInfoLoader = () => {
	return (
		// <li className='flex shadow-lg dark:shadow-gray-950 rounded-[40px] mb-4 animate-pulse'>
		// 	<svg
		...
		// 		<div className='h-5 bg-gray-200 rounded-full dark:bg-gray-700 w-24 mb-4' />
		// 		<div className='h-3 bg-gray-200 rounded-full dark:bg-gray-700 w-36 mb-2.5' />
		// 	</div>
		// </li>
