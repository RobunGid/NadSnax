...
export const UIProductItemBadges = withTranslate(
	({ isSecretbox, isBestseller, translate }: UIProductItemBadgesProps) => {
		return (
			<>
				{isSecretbox && (
					<div className='absolute bg-purple-300/70 px-2 text-purple-900 font-bold w-52 text-center rotate-[-45deg] top-[50px] left-[-45px]'>
						{translate('product_item.badges.secretbox')}
					</div>
				)}
				{isBestseller && (
					<div className='absolute bg-blue-200/70 px-2 text-blue-900 font-bold w-40 text-center -rotate-45 top-[27px] left-[-40px]'>
