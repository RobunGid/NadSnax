...
interface UIProductsPageProps {
	customerReviews: ReactNode[];
	translate: (text: string) => string;
}

export const UIProductsPage = ({ customerReviews, translate }: UIProductsPageProps) => {
	return (
		<div className='p-3'>
			<section className='flex justify-center items-center w-full'>
				<h1 className='text-3xl font-bold m-3'>{translate('homepage.slogan')}</h1>
			</section>
			...
			<section className='flex gap-3 py-3 space-x-3 w-full flex-wrap justify-around'>
				...
				<img src={JuiceHomeImage} alt='Juice Image' width='400' className='p-5' />
			</section>
